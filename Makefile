...
SRCS = blatt3.cpp world.cpp worldlc.cpp timediscretization.cpp gravitypotential.cpp velocityverlet.cpp velocityverletlc.cpp observer.cpp ljpotential.cpp
